...
def get_model(model_name):
    ...
    if model_name == "resnet18":
        ...
        transform = transforms.Compose([
            transforms.Resize((224, 224)),  # Skaliert die Bilder auf 224x224
            transforms.RandomHorizontalFlip(),
...
def train_model(model, epochs=10):
    ...
    end_time = time.time()
    torch.save(model.state_dict(), f'fine_tuned_cnn_{model_name}.pth')
...
# Running experiments
for model_name in ["efficientnet_b0"]: #"resnet18", "efficientnet_b0", "vit_b_16"
    print(f"\nTraining {model_name}...")
